...
- [x] **Lift tracker** (`src/app/lift/page.tsx`):
  - Day A / Day B template picker (templates are a `TEMPLATES` constant in this file — edit there to add/remove/rename exercises)
...
4. Bulgarian Split Squat — 3 × 6-8 ea
5. Step-ups — 3 × 6-10 ea (note: bodyweight, controlled)
6. Deadbugs — 3 × 8-12 ea (note: slow, full extension)
7. Plank — 3 × max **sec** (uses `unit: "sec"`)
8. Hip Abduction (optional) — 2 × 12-15
...
8. Hamstring Curls — 3 × 8-12
9. Bicep Curls (optional) — 2 × 10-15
10. Tricep Pushdowns (optional) — 2 × 10-15
